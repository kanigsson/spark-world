...
begin
   ...
   Check_Decode
     (BS & "uD834" & BS & "uDD1E", G_Clef, OK, "surrogate pair");
   Check_Decode
     (E_Acute & BS & "u20AC", E_Acute & Euro, OK,
   ...
   Check_Decode
     (BS & "uD800" & BS & "u0041", "", Invalid_Escape,
   ...
   Check_Invalid_UTF8
     ((1 => Character'Val (16#C0#), 2 => Character'Val (16#AF#)),
      "two-byte overlong");
   Check_Invalid_UTF8
     ((1 => Character'Val (16#E0#), 2 => Character'Val (16#80#),
       3 => Character'Val (16#80#)), "three-byte overlong");
   Check_Invalid_UTF8
     ((1 => Character'Val (16#F0#), 2 => Character'Val (16#80#),
       3 => Character'Val (16#80#), 4 => Character'Val (16#80#)),
      "four-byte overlong");
   Check_Invalid_UTF8
     ((1 => Character'Val (16#ED#), 2 => Character'Val (16#A0#),
       3 => Character'Val (16#80#)), "UTF-8 surrogate");
   Check_Invalid_UTF8
     ((1 => Character'Val (16#F4#), 2 => Character'Val (16#90#),
       3 => Character'Val (16#80#), 4 => Character'Val (16#80#)),
      "above U+10FFFF");
   Check_Invalid_UTF8
   ...
   Check_Invalid_UTF8
     ((1 => Character'Val (16#F0#), 2 => Character'Val (16#9F#),
       3 => Character'Val (16#98#)), "truncated four-byte");
   Check_Invalid_UTF8
