...
begin
   ...
   begin
      ...
      Check (Line_Span (Idx, 1) = (Start => 1, Length => 1)
             and then Str_Of (Line (Idx, B, 1)) = "a", "line 1 = a");
      Check (Line_Span (Idx, 2) = (Start => 3, Length => 2)
             and then Str_Of (Line (Idx, B, 2)) = "bb", "line 2 = bb");
      Check (Line_Span (Idx, 3) = (Start => 6, Length => 3)
             and then Str_Of (Line (Idx, B, 3)) = "ccc", "line 3 = ccc");
   ...
   begin
      ...
      Check (Str_Of (Line (Idx, B, 2)) = "bb", "CRLF line 2 = bb (CR stripped)");
   end;
   ...
   begin
      ...
      Check (Line_Span (Idx, 1).Length = 0 and then Line (Idx, B, 1)'Length = 0,
   ...
   begin
      ...
      Seal (Idx, B);
      Check (Line_Count (Idx) = 1 and then Str_Of (Line (Idx, B, 1)) = "abc",
   ...
   begin
      Scan (Idx, B);
      Check (Line_Count (Idx) = 1 and then Scanned_Bytes (Idx) = 2,
             "Scan: 1 line, cursor past the LF");
      Seal (Idx, B);
      Check (Line_Count (Idx) = 2 and then Str_Of (Line (Idx, B, 2)) = "y",
   ...
   begin
      ...
      Scan (Idx, B2);
      Check (Line_Count (Idx) = 2 and then Str_Of (Line (Idx, B2, 2)) = "cd",
   ...
   begin
      Scan (Idx, B);
      Check (Line_Count (Idx) = 1 and then Truncated (Idx),
   ...
   begin
      Scan (Idx, B);
      Check (Line_Count (Idx) = 0 and then Scanned_Bytes (Idx) = 0,
