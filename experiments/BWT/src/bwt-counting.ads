...
is
   ...
   with
     ...
     Pre                =>
       Seen'First = 1
       and then Seen'Length <= Max_Length
       and then Through <= Seen'Length,
     Post               =>
       Unseen'Result <= Through
   ...
   with
     ...
     Pre  =>
       ...
       and then not Before (Position)
       and then After (Position)
       and then (for all I in Before'Range =>
                   (if I /= Position then Before (I) = After (I))),
     Post => Unseen (Before, Before'Length) = Unseen (After, After'Length) + 1;
