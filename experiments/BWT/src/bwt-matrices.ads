...
is
   ...
   function Ordered_Image
     (S : String; Rows : Table; Map : Mapping) return Boolean
   is (for all I in Map'Range =>
         (for all J in I .. Map'Last =>
   ...
   with
     Pre  =>
       ...
       and then Supported (Last)
       and then Last'Length = S'Length
       and then Primary in Rows'Range
