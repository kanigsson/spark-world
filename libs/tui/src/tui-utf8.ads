...
is
   ...
   function Scalar_2 (B0, B1 : Tui.Byte) return Natural
   is ((Natural (B0) - 16#C0#) * 2**6 + (Natural (B1) - 16#80#))
   with
     Pre  =>
       Natural (B0) in 16#C2# .. 16#DF#
       and then Natural (B1) in 16#80# .. 16#BF#,
     Post => Scalar_2'Result <= 16#7FF#;

   function Scalar_3 (B0, B1, B2 : Tui.Byte) return Natural
   is ((Natural (B0) - 16#E0#)
       * 2**12
   ...
   with
     Pre  =>
       Natural (B0) in 16#E0# .. 16#EF#
       and then Natural (B1) in 16#80# .. 16#BF#
       and then Natural (B2) in 16#80# .. 16#BF#,
     Post => Scalar_3'Result <= 16#FFFF#;

   function Scalar_4 (B0, B1, B2, B3 : Tui.Byte) return Natural
   is ((Natural (B0) - 16#F0#)
       * 2**18
