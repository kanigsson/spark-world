...
begin
   Start ("test_engine", Echo_Passes => True);
   ...
   PE.Set_Pattern (E, Tui.Text.To_Buffer ("echo"));
   ...
   ----------------------------------------------------------------- search back
   PE.Set_Pattern (E, Tui.Text.To_Buffer ("alpha"));
   ...
   ----------------------------------------------------------------- search miss
   PE.Set_Pattern (E, Tui.Text.To_Buffer ("zzz"));
   declare
