...
is
   ...
   function C_Write
     (FD : int; Buf : System.Address; Count : size_t) return long
   ...
   function C_Poll
     (Fds : System.Address; N : unsigned_long; Timeout : int) return int
   ...
   begin
      if Data'Length = 0 then
         ...
         declare
            N : constant long :=
              C_Write
                (int (FD), Data (Data'First)'Address, size_t (Data'Length));
         begin
